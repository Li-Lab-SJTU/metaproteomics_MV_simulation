      ...
      for mr_all in mr_alls:
        for mr_nrandom in mr_nrandoms:
          ...
          for i in range(repeat_time):
            ...
            if not ((data.shape==data_na.shape==data_bpca.shape==data_sampmin.shape==data_qr.shape==data_rf.shape==data_knn.shape) or \
                      (data.shape==data_na.shape==data_sampmin.shape==data_qr.shape==data_rf.shape==data_knn.shape and data_bpca.shape==(1,1))):
