...
FDR=0.05
path_result=CD+'/simu_metrics/simu_metrics_100_10000_0.75simulation1.txt'

# Nround=100
# sample_size=[10,20,40,80,100,200] 
# feature_sizes=[10000]
# fclist=[1.2,1.5,1.8,2,3,5]
# zero_ratio=[0.3,0.5,0.7,0.9]
# mnar_ratio=[0.2,0.4,0.6,0.8]
# FDR=0.05
# path_result=CD+'/simu_metrics/simu_metrics_simulation2.txt'
